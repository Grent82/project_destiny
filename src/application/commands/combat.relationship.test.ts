...
describe('getRelationshipCombatModifier', () => {
  it('returns positive modifier for high loyalty+trust', () => {
    const rels = {
      'player-to-npc-1': { loyalty: 90, trust: 90, fear: 20, affinity: 50, respect: 50 }
    }
  ...
  it('returns negative modifier when fear is very high', () => {
    const rels = {
      'player-to-npc-1': { loyalty: 50, trust: 50, fear: 90, affinity: 50, respect: 50 }
    }
    const mod = getRelationshipCombatModifier('npc-1', rels)
  ...
  it('clamps modifier to [-0.15, +0.15]', () => {
    const rels = {
      'player-to-npc-2': { loyalty: 100, trust: 100, fear: 0, affinity: 100, respect: 100 }
    }
  ...
  it('returns 0 for neutral relationship (50/50)', () => {
    const rels = {
      'player-to-npc-3': { loyalty: 50, trust: 50, fear: 0, affinity: 50, respect: 50 }
    }
