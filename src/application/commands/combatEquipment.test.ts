...
const BASE_GAME_STATE = {
  ...
  factionStates: [],
  districts: [],
  npcRuntimeStates: [BASE_NPC_STATE, { ...BASE_NPC_STATE, npcId: 'npc-2' }],
  cityResources: {
    foodSecurity: 62,
    foodStock: 620,
    foodCapacity: 1000,
