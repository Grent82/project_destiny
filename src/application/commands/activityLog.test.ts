...
function createMinimalState(overrides: Partial<GameState> = {}): GameState {
  return {
    ...
    enabledActions: overrides.enabledActions ?? [],
    playerStatuses: overrides.playerStatuses ?? [],
    activeTrainingBonuses: overrides.activeTrainingBonuses ?? [],
    tempStatBoosts: overrides.tempStatBoosts ?? [],
    equippedTools: overrides.equippedTools ?? [],
    evidenceInventory: overrides.evidenceInventory ?? [],
    houseImprovements: overrides.houseImprovements ?? { waterQuality: 0, herbSupply: 0, entrySecurity: 0 },
    sleepQualityBonus: overrides.sleepQualityBonus ?? 0,
    ...
    timeSlotState: overrides.timeSlotState ?? {
      currentSlot: 'morning',
      slotQueue: [],
      completedTasks: [],
      skippedTasks: [],
    ...
    activeDirectives: overrides.activeDirectives ?? [],
    pendingDateProposals: overrides.pendingDateProposals ?? [],
    scheduledDates: overrides.scheduledDates ?? [],
    npcDateCooldowns: overrides.npcDateCooldowns ?? {},
    chronicle: overrides.chronicle ?? { version: 1, entriesByDay: {} },
    ...
    houseProposalCooldown: overrides.houseProposalCooldown ?? 0,
